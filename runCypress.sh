...
# $env:FUNCTIONARY="FUNC_LABORAL_ACUERDOS_01"; $env:CITIZEN="CIUDADANO_MANUEL"; npx cypress run --spec **/001_DatosDemandadoSeOcultan.cy.js,**/002_loginCredencialesIncorrectas.cy.js,**/003_BuscadorExpedienteAdmiteCharEspeciales.cy.js,**/001_DescargaManualUsuarioTramite.cy.js,**/007_EliminaProyectosEnvio.cy.js,**/001_DescargaManualUsuarioTramite.cy.js,**/001_IniciarCancelaTramite.cy.js,**/002_EliminaTramitesIniciados.cy.js,**/003_IniciaTramite.cy.js

# $env:FUNCTIONARY="FUNC_LABORAL_ACUERDOS_01"; $env:CITIZEN="CIUDADANO_MANUEL"; npx cypress run --spec **/004_TramiteSecretarioAcuerdos.cy.js
...
# $env:CITIZEN="CIUDADANO_MANUEL"; $env:FUNCTIONARY="FUNC_LABORAL_ACUERDOS_01"; npx cypress run --spec ./cypress/e2e/Ciudadano/ 
...
# Verifica si el archivo .env.sandbox existe y lo carga
...
#             echo "$key was loaded successfully"
#         fi
#     done < "$ENV_FILE"
# else
#     echo "ENV_FILE does not exist or is not a file."
#     exit 1
# fi